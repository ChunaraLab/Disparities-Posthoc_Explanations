...
def plot_accuracies(results, save_path):
    ...
    plt.xlabel('Ratio of M0 to M1', fontsize=14)
...
#objective 1a
FILENAMES = [
    'training_data_ratio_0.05.csv',
    'training_data_ratio_0.1.csv',
    'training_data_ratio_0.15.csv',
    'training_data_ratio_0.2.csv',
    'training_data_ratio_0.25.csv',
    'training_data_ratio_0.3.csv',
    'training_data_ratio_0.35.csv',
    'training_data_ratio_0.4.csv',
...
BASE_PATH = '/Users/salman/Desktop/exp_qua/new_3_objective/dgp_final/plot_data/objective_1_final/case-a/'

test_data_path = '/Users/salman/Desktop/exp_qua/new_3_objective/dgp_final/plot_data/objective_1_final/case-a/testing_data_objective_1a.csv'
...
def main(args):
    ...
    # base_plot_path = "/Users/salman/Desktop/exp_qua/new_3_objective/explanation/final-explanation-result"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='lr', help='Model to use for classification') #'lr', 'nn'
    parser.add_argument('--k', type = int, default=2, help = 'k top feature, use k = 3 adult income data')
    parser.add_argument('--setup', type = int, default=1, help = 'Defining the setup') # setup 2 means no M in the model training 
